    ...
    <div className="container mt-5">
      <div className="row">
        ...
        <div className="col-6">
          ...
          <div className="mt-4"><button className={props.outfitInfo.availability ? "btn btn-dark" : "btn btn-secondary"}>{props.outfitInfo.availability ? "Available" : "Sold Out"}</button></div>
